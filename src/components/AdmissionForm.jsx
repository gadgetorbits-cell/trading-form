...
function AdmissionForm() {
  ...
  const GOOGLE_SCRIPT_URL ='https://script.google.com/macros/s/AKfycbz__k-3bUae7mXy-xCW2KoX4wJIJiR5UINT-clcWhchVyoyT2UZgkfXp6M7N_6zQHv63Q/exec';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/RegistrationFees', { state: { formData: formData } });
      }, 500);
      ...
      <div className="af-register-card">
        ...
        {submitStatus === 'error' && (
          <div style={{
            ...
            ⚠️ Registration submitted. Redirecting...
          </div>
        )}
